...
/**
 * This is the model class for table "{{%folder_material_team}}".
 * @SWG\Definition(type="object", @SWG\Xml(name="FolderMaterialTeam"))
 *
 ...
 */
class FolderMaterialTeam extends \yii\db\ActiveRecord
{
    ...
    {
        {
            return FolderMaterialTeam::find()->orderBy(['created_at' => SORT_DESC]);
        }
    }
