...
class MaterialMember extends \yii\db\ActiveRecord
{
     ...
     * @var array 前端页面返回参数
     */
    static $frontendFields = ['title', 'source', 'sid', 'folder_id', 'user_id', 'width', 'height', 'size', 'status', 'session_id', 'filename', 'old_name'];
    ...
    {
        return [
            [['source', 'sid', 'user_id', 'width', 'height', 'size', 'status', 'folder_id', 'created_at', 'updated_at'], 'integer'],
