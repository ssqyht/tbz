...
/**
 * This is the model class for table "{{%folder_template_team}}".
 * @SWG\Definition(type="object", @SWG\Xml(name="FolderTemplateTeam"))
 *
 ...
 */
class FolderTemplateTeam extends \yii\db\ActiveRecord
{
    ...
    {
        {
            return FolderTemplateTeam::find()->orderBy(['created_at' => SORT_DESC]);
        }
    }
